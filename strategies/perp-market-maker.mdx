...
────────────────┼────────────────────────────
< 4 hours       │ Wait for TP
4-8 hours       │ Tighten TP target
8 hours         │ Exit at breakeven if possible
8-24 hours      │ Accept small loss exit
24+ hours       │ Force exit (market order)
```
...
<ParamField path="time_decay.breakeven_after_seconds" type="integer" default="28800">
  Exit at breakeven after this many seconds (8 hours).
</ParamField>
...
- Breakeven: 8 hours (28800 seconds)
- Exit Loss: 8 hours (28800 seconds)
- Force Exit: 24 hours (86400 seconds)
