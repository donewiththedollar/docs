...
<Accordion title="What symbol do the vaults trade?">
  Each vault has a default symbol (currently ASTER/USDT:USDT), but you can select from 12 popular symbols or enter any custom symbol before deploying. Popular options include BTC, ETH, SOL, DOGE, XRP, SUI, PEPE, LINK, AVAX, ARB, OP, and WIF.
</Accordion>
